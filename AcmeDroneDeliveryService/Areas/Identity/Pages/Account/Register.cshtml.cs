...
namespace AcmeDroneDeliveryService.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [RegularExpression(@"^(?=.*[A-Z])(?=.*\d)(?=.*[&^%$#@]).{10,}$", ErrorMessage = "The {0} must be 10 characters long, must contain one digit, one uppercase and one special character.")]
